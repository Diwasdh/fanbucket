<div class="modal fade modal--post modal--edit modal--shareFeed modal--shareMessage" id="shareMessage--modal"  data-keyboard="true" tabindex="-1">
	<div class="modal-dialog ">
		<div class="modal-content">
			<div class="modal-header title__wrapper">
				<h2 class="section__title">Send in Message</h2>
			...
			<div class="modal-body">
				...
				<form action="#!" method="" >
					<div class="form__wrapper">
						<div class="form-group">
							<textarea name="editContent"  class="form-control" placeholder="Write Your Message" maxlength="200"></textarea>
									...
									<div class="card__body">
										...
										<div class="image--multi">
											...
											<div class="image--multi__left ">
												...
												<div class="card__img small__img locked bg">
													<div class="absolute__link">
				...
				<div class="form-upolading loader__wrapper">
					...
					<h2 class="section__title">Sharing</h2>
				</div>
			</div>
		</div>
	</div>
