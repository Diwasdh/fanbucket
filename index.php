	...
	<section class="moments">
		...
		<div class="stories d-flex ">
			...
			<div class="img__wrapper">
				...
				<a  href="#" class="para small">Simran away</a>
			</div>
			<div class="img__wrapper">
				<a class="card__img  active" href="#">
	...
	<section class="feed">
		...
		<article class="card">
			...
			<div class="card__action">
				...
				<div class="dropdown">
					<a href="#" class="share dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<div class="dropdown-menu">
						<li class="nav-item">
							<button class="nav-link dropdown-item edit--post--trigger" href="#" data-toggle="modal" data-target="#shareFeed--modal">
								Share In Your Feeds
							</button>
						</li>
						<li class="nav-item">
							<button class="nav-link dropdown-item" href="#" data-toggle="modal" data-target="#shareMessage--modal">
								Send in Message
							</button>
						</li>
						<li class="nav-item">
		...
		<article class="card shared">
			<div class="card__top">
				<a class="card__img">
					<img src="./gallery/allef-vinicius-QHvtBAYVcfw-unsplash-min.jpg" alt="">
				</a>
				<div class="card__top__body">
					<h2 class="card__title"><a href="#">Natsuki Subaru</a></h2>
					<time>3 minutes ago</time>
				</div>
				<div class="card__top__link dropdown " >
					<a class="dropdown-toggle" type="button"  data-toggle="dropdown" href="#!" data-target="postone__dropdown" data-disabled="true">
				...
				<a href="#!" class="card ">
					<div class="card__body">
						<div class="image--multi">
							...
							<div class="image--multi__left ">
								<div class="card__img small__img ">
									<img src="./gallery/matheus-ferrero-pg_WCHWSdT8-unsplash-min.jpg" alt="">
								</div>
								<div class="card__img small__img ">
									<img src="./gallery/sinval-carvalho-OF_lAQBbnEY-unsplash-min.jpg" alt="">
						...
						<p class="user__text">this is a shared post. Chilling out on my own !
						Everyone lie about it</p>
					</div>
					<div class="card__top">
						<div class="card__img">
						...
						<div class="card__top__body">
							<h2 class="card__title">Charles</h2>
							<time>3 minutes ago</time>
						</div>
					</div>
				</a>
